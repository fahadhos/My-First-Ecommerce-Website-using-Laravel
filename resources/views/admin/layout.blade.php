...
<head>
   ...
   <link href="{{asset('https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.9.0/css/all.min.css')}}" rel="stylesheet" media="all">
...
<body class="animsition">
    <div class="page-wrapper">
                ...
                <div class="container-fluid">
                    <div class="header-mobile-inner">
                        <a class="logo" href="index.html">
                            <img src="{{asset('admin_assets/images/icon/shop1.png')}}" alt=" Admin" />
                        </a>
                ...
                <div class="container-fluid">
                    <ul class="navbar-mobile__list list-unstyled">
                        ...
                        <a href="{{url('admin/category')}}">
                                <i class="fas fa-list-alt" aria-hidden="true"> </i>Category
                            </a>
                        </li>
                        <li>
                        <a href="{{url('admin/coupon')}}">
                                <i class="fas fa-gift" aria-hidden="true"> </i>Coupon
                            </a>
                        </li>
        ...
        <aside class="menu-sidebar d-none d-lg-block">
            <div class="logo">
                <a href="#">
                    <img src="{{asset('admin_assets/images/icon/shop1.png')}}" alt="Cool Admin" />
                </a>
            </div>
                            ...
                            <div class="header-button">
                                ...
                                <div class="account-wrap">
                                    <div class="account-item clearfix js-item-menu">
                                        ...
                                        <div class="content">
                                          <i class="fas fa-user"></i>  <a class="js-acc-btn" href="#">Welcome Fahad </a>
                                        </div>
